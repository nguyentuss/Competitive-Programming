 ...
 * The voronoi diagram vertices are the circumcenters of each triangle (use \texttt{circumcircle.h}).
 * The voronoi edges are the projection of the voronoi vertices to each of their respective triangle sides.
 * Time: O(n \log n)
